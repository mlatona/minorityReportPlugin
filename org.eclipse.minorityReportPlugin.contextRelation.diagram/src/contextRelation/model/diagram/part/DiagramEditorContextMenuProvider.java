...
public class DiagramEditorContextMenuProvider extends DiagramContextMenuProvider {
	...
	* @generated
	*/
	private contextRelation.model.diagram.part.DeleteElementAction deleteAction;
	...
	*/
	public DiagramEditorContextMenuProvider(IWorkbenchPart part, EditPartViewer viewer) {
		super(part, viewer);
		this.part = part;
		deleteAction = new contextRelation.model.diagram.part.DeleteElementAction(part);
		deleteAction.init();
	}
