 ...
 * @generated
 */
public class GeneratorParserProvider extends AbstractProvider implements IParserProvider {
	...
	*/
	public IParser getParser(IAdaptable hint) {
		...
		if (vid != null) {
			return getParser(GeneratorVisualIDRegistry.getVisualID(vid));
		}
		View view = (View) hint.getAdapter(View.class);
		if (view != null) {
			return getParser(GeneratorVisualIDRegistry.getVisualID(view));
		}
		return null;
	}
	...
	*/
	public boolean provides(IOperation operation) {
		if (operation instanceof GetParserOperation) {
			...
			if (GeneratorElementTypes.getElement(hint) == null) {
				return false;
			}
