...
public class ModelNavigatorLabelProvider extends LabelProvider implements ICommonLabelProvider, ITreePathLabelProvider {
	...
	public Image getImage(View view) {
		...
		case InstanceEditPart.VISUAL_ID:
			return getImage("Navigator?TopLevelNode?https://github.com/mlatona/minorityReportPlugin?Instance", //$NON-NLS-1$
					ModelElementTypes.Instance_2001);
		case ContextRelationEditPart.VISUAL_ID:
			return getImage("Navigator?TopLevelNode?https://github.com/mlatona/minorityReportPlugin?ContextRelation", //$NON-NLS-1$
					ModelElementTypes.ContextRelation_2002);
		...
		case HappensEditPart.VISUAL_ID:
			return getImage("Navigator?TopLevelNode?https://github.com/mlatona/minorityReportPlugin?Happens", //$NON-NLS-1$
					ModelElementTypes.Happens_2009);
		...
		case HoldsAtBetweenEditPart.VISUAL_ID:
			return getImage("Navigator?TopLevelNode?https://github.com/mlatona/minorityReportPlugin?HoldsAtBetween", //$NON-NLS-1$
					ModelElementTypes.HoldsAtBetween_2011);
		case InitiallyHoldsAtsEditPart.VISUAL_ID:
			return getImage("Navigator?Link?https://github.com/mlatona/minorityReportPlugin?Initially?holdsAts", //$NON-NLS-1$
					ModelElementTypes.InitiallyHoldsAts_4001);
		...
		case InitiallyContextRelationEditPart.VISUAL_ID:
			return getImage("Navigator?Link?https://github.com/mlatona/minorityReportPlugin?Initially?contextRelation", //$NON-NLS-1$
					ModelElementTypes.InitiallyContextRelation_4003);
		case InstanceTypeEditPart.VISUAL_ID:
			return getImage("Navigator?Link?https://github.com/mlatona/minorityReportPlugin?Instance?type", //$NON-NLS-1$
					ModelElementTypes.InstanceType_4004);
		case InitiallyHappensEditPart.VISUAL_ID:
			return getImage("Navigator?Link?https://github.com/mlatona/minorityReportPlugin?Initially?happens", //$NON-NLS-1$
					ModelElementTypes.InitiallyHappens_4005);
		case ParameterInstanceEditPart.VISUAL_ID:
			return getImage("Navigator?Link?https://github.com/mlatona/minorityReportPlugin?Parameter?instance", //$NON-NLS-1$
					ModelElementTypes.ParameterInstance_4006);
		...
		case ParameterTypeEditPart.VISUAL_ID:
			return getImage("Navigator?Link?https://github.com/mlatona/minorityReportPlugin?Parameter?type", //$NON-NLS-1$
					ModelElementTypes.ParameterType_4008);
		case HoldsAtContextRelationEditPart.VISUAL_ID:
			return getImage("Navigator?Link?https://github.com/mlatona/minorityReportPlugin?HoldsAt?contextRelation", //$NON-NLS-1$
					ModelElementTypes.HoldsAtContextRelation_4009);
		...
		case ContextRelationParametersEditPart.VISUAL_ID:
			return getImage("Navigator?Link?https://github.com/mlatona/minorityReportPlugin?ContextRelation?parameters", //$NON-NLS-1$
					ModelElementTypes.ContextRelationParameters_4013);
		case InitiallyHoldsAtBetweensEditPart.VISUAL_ID:
			return getImage("Navigator?Link?https://github.com/mlatona/minorityReportPlugin?Initially?holdsAtBetweens", //$NON-NLS-1$
					ModelElementTypes.InitiallyHoldsAtBetweens_4014);
		...
		case HappensEventEditPart.VISUAL_ID:
			return getImage("Navigator?Link?https://github.com/mlatona/minorityReportPlugin?Happens?event", //$NON-NLS-1$
					ModelElementTypes.HappensEvent_4019);
		}
	...
	*/
	public String getText(View view) {
		...
		case InitiallyHoldsAtsEditPart.VISUAL_ID:
			return getInitiallyHoldsAts_4001Text(view);
		case HoldsAtBetweenContextRelationEditPart.VISUAL_ID:
			return getHoldsAtBetweenContextRelation_4002Text(view);
		case InitiallyContextRelationEditPart.VISUAL_ID:
			return getInitiallyContextRelation_4003Text(view);
		case InstanceTypeEditPart.VISUAL_ID:
			return getInstanceType_4004Text(view);
		case InitiallyHappensEditPart.VISUAL_ID:
			return getInitiallyHappens_4005Text(view);
		case ParameterInstanceEditPart.VISUAL_ID:
			return getParameterInstance_4006Text(view);
		case BehaviouralDescriptionHoldsAtBetweensEditPart.VISUAL_ID:
			return getBehaviouralDescriptionHoldsAtBetweens_4007Text(view);
		case ParameterTypeEditPart.VISUAL_ID:
			return getParameterType_4008Text(view);
		case HoldsAtContextRelationEditPart.VISUAL_ID:
			return getHoldsAtContextRelation_4009Text(view);
		case ComplexEventBehaviouralDescriptionsEditPart.VISUAL_ID:
			return getComplexEventBehaviouralDescriptions_4010Text(view);
		case BehaviouralDescriptionHoldsAtsEditPart.VISUAL_ID:
			return getBehaviouralDescriptionHoldsAts_4012Text(view);
		case ContextRelationParametersEditPart.VISUAL_ID:
			return getContextRelationParameters_4013Text(view);
		case InitiallyHoldsAtBetweensEditPart.VISUAL_ID:
			return getInitiallyHoldsAtBetweens_4014Text(view);
		case ContextRelationEndingComplexEventEditPart.VISUAL_ID:
			return getContextRelationEndingComplexEvent_4015Text(view);
		case BehaviouralDescriptionHappensEditPart.VISUAL_ID:
			return getBehaviouralDescriptionHappens_4016Text(view);
		case ContextRelationInitialComplexEventEditPart.VISUAL_ID:
			return getContextRelationInitialComplexEvent_4017Text(view);
		case HappensEventEditPart.VISUAL_ID:
			return getHappensEvent_4019Text(view);
		}
	...
	*/
	private String getInstance_2001Text(View view) {
		IParser parser = ModelParserProvider.getParser(ModelElementTypes.Instance_2001,
	...
	*/
	private String getContextRelation_2002Text(View view) {
		IParser parser = ModelParserProvider.getParser(ModelElementTypes.ContextRelation_2002,
				view.getElement() != null ? view.getElement() : view,
	...
	*/
	private String getPrimitiveEvent_2004Text(View view) {
		IParser parser = ModelParserProvider.getParser(ModelElementTypes.PrimitiveEvent_2004,
				view.getElement() != null ? view.getElement() : view,
	...
	*/
	private String getComplexEvent_2005Text(View view) {
		IParser parser = ModelParserProvider.getParser(ModelElementTypes.ComplexEvent_2005,
				view.getElement() != null ? view.getElement() : view,
	...
	*/
	private String getParameter_2006Text(View view) {
		IParser parser = ModelParserProvider.getParser(ModelElementTypes.Parameter_2006,
				view.getElement() != null ? view.getElement() : view,
	...
	*/
	private String getType_2008Text(View view) {
		IParser parser = ModelParserProvider.getParser(ModelElementTypes.Type_2008,
				view.getElement() != null ? view.getElement() : view,
	...
	*/
	private String getBehaviouralDescription_2010Text(View view) {
		IParser parser = ModelParserProvider.getParser(ModelElementTypes.BehaviouralDescription_2010,
				view.getElement() != null ? view.getElement() : view,
	...
	*/
	private String getHoldsAtBetween_2011Text(View view) {
		...
		if (domainModelElement != null) {
			...
			ModelDiagramEditorPlugin.getInstance().logError("No domain element for view with visualID = " + 2011); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	* @generated
	*/
	private String getInitiallyHoldsAts_4001Text(View view) {
		return ""; //$NON-NLS-1$
	}
	...
	* @generated
	*/
	private String getHoldsAtBetweenContextRelation_4002Text(View view) {
		return ""; //$NON-NLS-1$
	}
	...
	* @generated
	*/
	private String getInitiallyContextRelation_4003Text(View view) {
		return ""; //$NON-NLS-1$
	}
	...
	* @generated
	*/
	private String getInstanceType_4004Text(View view) {
		return ""; //$NON-NLS-1$
	}
	...
	* @generated
	*/
	private String getInitiallyHappens_4005Text(View view) {
		return ""; //$NON-NLS-1$
	}
	...
	* @generated
	*/
	private String getParameterInstance_4006Text(View view) {
		return ""; //$NON-NLS-1$
	}
	...
	* @generated
	*/
	private String getParameterType_4008Text(View view) {
		return ""; //$NON-NLS-1$
	}
	...
	* @generated
	*/
	private String getHoldsAtContextRelation_4009Text(View view) {
		return ""; //$NON-NLS-1$
	}
	...
	* @generated
	*/
	private String getBehaviouralDescriptionHoldsAts_4012Text(View view) {
		return ""; //$NON-NLS-1$
	}
	...
	* @generated
	*/
	private String getContextRelationParameters_4013Text(View view) {
		return ""; //$NON-NLS-1$
	}
	...
	* @generated
	*/
	private String getInitiallyHoldsAtBetweens_4014Text(View view) {
		return ""; //$NON-NLS-1$
	}
	...
	* @generated
	*/
	private String getContextRelationEndingComplexEvent_4015Text(View view) {
		return ""; //$NON-NLS-1$
	}
	...
	* @generated
	*/
	private String getBehaviouralDescriptionHappens_4016Text(View view) {
		return ""; //$NON-NLS-1$
	}
	...
	* @generated
	*/
	private String getContextRelationInitialComplexEvent_4017Text(View view) {
		return ""; //$NON-NLS-1$
	}
	...
	* @generated
	*/
	private String getHappensEvent_4019Text(View view) {
		return ""; //$NON-NLS-1$
	}
