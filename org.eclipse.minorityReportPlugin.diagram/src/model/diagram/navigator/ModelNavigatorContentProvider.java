	...
	*/
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case PrimitiveEventEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			ModelNavigatorGroup incominglinks = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_PrimitiveEvent_2004_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					ModelVisualIDRegistry.getType(HappensEventEditPart.VISUAL_ID));
		...
		case InitiallyHoldsAtsEditPart.VISUAL_ID: {
			...
			ModelNavigatorGroup target = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_InitiallyHoldsAts_4001_target, "icons/linkTargetNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			ModelNavigatorGroup source = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_InitiallyHoldsAts_4001_source, "icons/linkSourceNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
		...
		case HoldsAtBetweenContextRelationEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			ModelNavigatorGroup target = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_HoldsAtBetweenContextRelation_4002_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			ModelNavigatorGroup source = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_HoldsAtBetweenContextRelation_4002_source,
		...
		case InitiallyContextRelationEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			ModelNavigatorGroup target = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_InitiallyContextRelation_4003_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			ModelNavigatorGroup source = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_InitiallyContextRelation_4003_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					ModelVisualIDRegistry.getType(ContextRelationEditPart.VISUAL_ID));
		...
		case InstanceTypeEditPart.VISUAL_ID: {
			LinkedList<ModelAbstractNavigatorItem> result = new LinkedList<ModelAbstractNavigatorItem>();
			Edge sv = (Edge) view;
			ModelNavigatorGroup target = new ModelNavigatorGroup(Messages.NavigatorGroupName_InstanceType_4004_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			ModelNavigatorGroup source = new ModelNavigatorGroup(Messages.NavigatorGroupName_InstanceType_4004_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					ModelVisualIDRegistry.getType(TypeEditPart.VISUAL_ID));
		...
		case InitiallyHappensEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			ModelNavigatorGroup target = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_InitiallyHappens_4005_target, "icons/linkTargetNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			ModelNavigatorGroup source = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_InitiallyHappens_4005_source, "icons/linkSourceNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					ModelVisualIDRegistry.getType(HappensEditPart.VISUAL_ID));
		...
		case ParameterInstanceEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			ModelNavigatorGroup target = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_ParameterInstance_4006_target, "icons/linkTargetNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			ModelNavigatorGroup source = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_ParameterInstance_4006_source, "icons/linkSourceNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					ModelVisualIDRegistry.getType(InstanceEditPart.VISUAL_ID));
		...
		case ParameterTypeEditPart.VISUAL_ID: {
			LinkedList<ModelAbstractNavigatorItem> result = new LinkedList<ModelAbstractNavigatorItem>();
			Edge sv = (Edge) view;
			ModelNavigatorGroup target = new ModelNavigatorGroup(Messages.NavigatorGroupName_ParameterType_4008_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			ModelNavigatorGroup source = new ModelNavigatorGroup(Messages.NavigatorGroupName_ParameterType_4008_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					ModelVisualIDRegistry.getType(TypeEditPart.VISUAL_ID));
		...
		case HoldsAtContextRelationEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			ModelNavigatorGroup target = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_HoldsAtContextRelation_4009_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			ModelNavigatorGroup source = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_HoldsAtContextRelation_4009_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					ModelVisualIDRegistry.getType(ContextRelationEditPart.VISUAL_ID));
		...
		case BehaviouralDescriptionHoldsAtsEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			ModelNavigatorGroup target = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_BehaviouralDescriptionHoldsAts_4012_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			ModelNavigatorGroup source = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_BehaviouralDescriptionHoldsAts_4012_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					ModelVisualIDRegistry.getType(HoldsAtEditPart.VISUAL_ID));
		...
		case ContextRelationParametersEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			ModelNavigatorGroup target = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_ContextRelationParameters_4013_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			ModelNavigatorGroup source = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_ContextRelationParameters_4013_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					ModelVisualIDRegistry.getType(ParameterEditPart.VISUAL_ID));
		...
		case InitiallyHoldsAtBetweensEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			ModelNavigatorGroup target = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_InitiallyHoldsAtBetweens_4014_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			ModelNavigatorGroup source = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_InitiallyHoldsAtBetweens_4014_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					ModelVisualIDRegistry.getType(HoldsAtBetweenEditPart.VISUAL_ID));
		...
		case ContextRelationEndingComplexEventEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			ModelNavigatorGroup target = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_ContextRelationEndingComplexEvent_4015_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			ModelNavigatorGroup source = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_ContextRelationEndingComplexEvent_4015_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					ModelVisualIDRegistry.getType(ComplexEventEditPart.VISUAL_ID));
		...
		case BehaviouralDescriptionHappensEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			ModelNavigatorGroup target = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_BehaviouralDescriptionHappens_4016_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			ModelNavigatorGroup source = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_BehaviouralDescriptionHappens_4016_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					ModelVisualIDRegistry.getType(HappensEditPart.VISUAL_ID));
		...
		case ContextRelationInitialComplexEventEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			ModelNavigatorGroup target = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_ContextRelationInitialComplexEvent_4017_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			ModelNavigatorGroup source = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_ContextRelationInitialComplexEvent_4017_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					ModelVisualIDRegistry.getType(ComplexEventEditPart.VISUAL_ID));
		...
		case HappensEventEditPart.VISUAL_ID: {
			LinkedList<ModelAbstractNavigatorItem> result = new LinkedList<ModelAbstractNavigatorItem>();
			Edge sv = (Edge) view;
			ModelNavigatorGroup target = new ModelNavigatorGroup(Messages.NavigatorGroupName_HappensEvent_4019_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			ModelNavigatorGroup source = new ModelNavigatorGroup(Messages.NavigatorGroupName_HappensEvent_4019_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					ModelVisualIDRegistry.getType(PrimitiveEventEditPart.VISUAL_ID));
