...
public class ContextRelationItemSemanticEditPolicy extends ModelBaseItemSemanticEditPolicy {
	...
	*/
	public ContextRelationItemSemanticEditPolicy() {
		super(ModelElementTypes.ContextRelation_2002);
	}
	...
	*/
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		if (ModelElementTypes.HoldsAtBetweenContextRelation_4002 == req.getElementType()) {
			return null;
		}
		if (ModelElementTypes.InitiallyContextRelation_4003 == req.getElementType()) {
			return null;
		}
		if (ModelElementTypes.HoldsAtContextRelation_4009 == req.getElementType()) {
			return null;
		}
		...
		if (ModelElementTypes.ContextRelationEndingComplexEvent_4015 == req.getElementType()) {
			return getGEFWrapper(
					new ContextRelationEndingComplexEventCreateCommand(req, req.getSource(), req.getTarget()));
		}
		if (ModelElementTypes.ContextRelationInitialComplexEvent_4017 == req.getElementType()) {
			return getGEFWrapper(
