...
import model.diagram.edit.commands.HappensEventCreateCommand;
import model.diagram.edit.commands.HappensEventReorientCommand;
...
public class HappensItemSemanticEditPolicy extends ModelBaseItemSemanticEditPolicy {
	...
	*/
	public HappensItemSemanticEditPolicy() {
		super(ModelElementTypes.Happens_2009);
	}
	...
	*/
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		if (ModelElementTypes.InitiallyHappens_4005 == req.getElementType()) {
			return null;
		}
		if (ModelElementTypes.BehaviouralDescriptionHappens_4016 == req.getElementType()) {
			return null;
		}
		if (ModelElementTypes.HappensEvent_4019 == req.getElementType()) {
