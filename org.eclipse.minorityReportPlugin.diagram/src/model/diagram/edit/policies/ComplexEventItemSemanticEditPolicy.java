 ...
 * @generated
 */
public class ComplexEventItemSemanticEditPolicy extends GeneratorBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public ComplexEventItemSemanticEditPolicy() {
		super(GeneratorElementTypes.ComplexEvent_2005);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (GeneratorVisualIDRegistry.getVisualID(outgoingLink) == EventParametersEditPart.VISUAL_ID) {
