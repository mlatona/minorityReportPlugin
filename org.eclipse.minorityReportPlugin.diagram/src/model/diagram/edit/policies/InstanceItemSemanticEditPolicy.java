 ...
 * @generated
 */
public class InstanceItemSemanticEditPolicy extends GeneratorBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public InstanceItemSemanticEditPolicy() {
		super(GeneratorElementTypes.Instance_2001);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (GeneratorVisualIDRegistry.getVisualID(incomingLink) == ParameterInstanceEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (GeneratorVisualIDRegistry.getVisualID(outgoingLink) == InstanceTypeEditPart.VISUAL_ID) {
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		if (GeneratorElementTypes.InstanceType_4005 == req.getElementType()) {
