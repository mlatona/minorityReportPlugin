...
public class InitiallyItemSemanticEditPolicy extends ModelBaseItemSemanticEditPolicy {
	...
	*/
	public InitiallyItemSemanticEditPolicy() {
		super(ModelElementTypes.Initially_2007);
	}
	...
	*/
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		if (ModelElementTypes.InitiallyHoldsAts_4001 == req.getElementType()) {
		...
		if (ModelElementTypes.InitiallyHoldsAtBetweens_4014 == req.getElementType()) {
