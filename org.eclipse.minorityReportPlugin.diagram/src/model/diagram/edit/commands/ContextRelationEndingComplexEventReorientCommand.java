 ...
 * @generated
 */
public class ContextRelationEndingComplexEventReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ContextRelationEndingComplexEventReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return ModelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistContextRelationEndingComplexEvent_4015(getNewSource(), getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return ModelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistContextRelationEndingComplexEvent_4015(getOldSource(), getNewTarget());
	}
	...
	*/
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setEndingComplexEvent(null);
		getNewSource().setEndingComplexEvent(getOldTarget());
	...
	*/
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setEndingComplexEvent(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
