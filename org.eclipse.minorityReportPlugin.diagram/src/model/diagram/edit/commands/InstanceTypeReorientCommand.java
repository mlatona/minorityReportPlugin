...
public class InstanceTypeReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return ModelBaseItemSemanticEditPolicy.getLinkConstraints().canExistInstanceType_4004(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return ModelBaseItemSemanticEditPolicy.getLinkConstraints().canExistInstanceType_4004(getOldSource(),
				getNewTarget());
	}
