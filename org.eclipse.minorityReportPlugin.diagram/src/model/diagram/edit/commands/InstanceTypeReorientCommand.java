...
public class InstanceTypeReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return GeneratorBaseItemSemanticEditPolicy.getLinkConstraints().canExistInstanceType_4005(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return GeneratorBaseItemSemanticEditPolicy.getLinkConstraints().canExistInstanceType_4005(getOldSource(),
				getNewTarget());
	}
