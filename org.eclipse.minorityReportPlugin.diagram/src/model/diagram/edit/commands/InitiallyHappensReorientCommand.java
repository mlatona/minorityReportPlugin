...
public class InitiallyHappensReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return GeneratorBaseItemSemanticEditPolicy.getLinkConstraints().canExistInitiallyHappens_4004(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return GeneratorBaseItemSemanticEditPolicy.getLinkConstraints().canExistInitiallyHappens_4004(getOldSource(),
				getNewTarget());
	}
