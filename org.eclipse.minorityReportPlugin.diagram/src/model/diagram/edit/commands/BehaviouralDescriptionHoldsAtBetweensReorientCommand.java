...
public class BehaviouralDescriptionHoldsAtBetweensReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return ModelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistBehaviouralDescriptionHoldsAtBetweens_4007(getNewSource(), getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return ModelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistBehaviouralDescriptionHoldsAtBetweens_4007(getOldSource(), getNewTarget());
	}
