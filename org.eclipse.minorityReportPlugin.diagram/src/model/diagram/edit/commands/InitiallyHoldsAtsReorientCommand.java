...
public class InitiallyHoldsAtsReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return GeneratorBaseItemSemanticEditPolicy.getLinkConstraints().canExistInitiallyHoldsAts_4006(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return GeneratorBaseItemSemanticEditPolicy.getLinkConstraints().canExistInitiallyHoldsAts_4006(getOldSource(),
				getNewTarget());
	}
