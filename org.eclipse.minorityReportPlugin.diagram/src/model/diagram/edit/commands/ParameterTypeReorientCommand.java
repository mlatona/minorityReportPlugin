...
public class ParameterTypeReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return ModelBaseItemSemanticEditPolicy.getLinkConstraints().canExistParameterType_4008(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return ModelBaseItemSemanticEditPolicy.getLinkConstraints().canExistParameterType_4008(getOldSource(),
				getNewTarget());
	}
