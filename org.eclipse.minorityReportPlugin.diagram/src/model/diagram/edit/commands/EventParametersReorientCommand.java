...
public class EventParametersReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return GeneratorBaseItemSemanticEditPolicy.getLinkConstraints().canExistEventParameters_4002(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return GeneratorBaseItemSemanticEditPolicy.getLinkConstraints().canExistEventParameters_4002(getOldSource(),
				getNewTarget());
	}
