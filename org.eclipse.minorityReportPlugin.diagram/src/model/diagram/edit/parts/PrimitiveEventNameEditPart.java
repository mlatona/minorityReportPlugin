...
public class PrimitiveEventNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ModelParserProvider.getParser(ModelElementTypes.PrimitiveEvent_2004, getParserElement(),
					ModelVisualIDRegistry.getType(model.diagram.edit.parts.PrimitiveEventNameEditPart.VISUAL_ID));
		}
		return parser;
	}
