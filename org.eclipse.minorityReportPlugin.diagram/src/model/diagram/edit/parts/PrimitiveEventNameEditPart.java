...
public class PrimitiveEventNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GeneratorParserProvider.getParser(GeneratorElementTypes.PrimitiveEvent_2004, getParserElement(),
					GeneratorVisualIDRegistry.getType(model.diagram.edit.parts.PrimitiveEventNameEditPart.VISUAL_ID));
		}
		return parser;
	}
