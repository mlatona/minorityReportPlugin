 ...
 * @generated
 */
public class ContextRelationTimeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ContextRelationTimeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ModelParserProvider.getParser(ModelElementTypes.ContextRelation_2002, getParserElement(),
					ModelVisualIDRegistry.getType(model.diagram.edit.parts.ContextRelationTimeEditPart.VISUAL_ID));
		}
		return parser;
	}
