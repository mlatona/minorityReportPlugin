...
import model.diagram.edit.policies.InstanceItemSemanticEditPolicy;
...
public class InstanceEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InstanceNameEditPart) {
			((InstanceNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureTypeNameFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(GeneratorVisualIDRegistry.getType(InstanceNameEditPart.VISUAL_ID));
	}
