...
public class WrappingLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ModelParserProvider.getParser(ModelElementTypes.Type_2008, getParserElement(),
					ModelVisualIDRegistry.getType(model.diagram.edit.parts.WrappingLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
