...
import model.diagram.edit.policies.ComplexEventItemSemanticEditPolicy;
...
public class ComplexEventEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ComplexEventNameEditPart) {
			((ComplexEventNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureTypeNameFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(GeneratorVisualIDRegistry.getType(ComplexEventNameEditPart.VISUAL_ID));
	}
