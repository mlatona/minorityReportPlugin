...
import model.diagram.edit.policies.ParameterItemSemanticEditPolicy;
...
public class ParameterEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ParameterNameEditPart) {
			((ParameterNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureTypeNameFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(GeneratorVisualIDRegistry.getType(ParameterNameEditPart.VISUAL_ID));
	}
