...
public class ContextRelationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GeneratorParserProvider.getParser(GeneratorElementTypes.ContextRelation_2002, getParserElement(),
					GeneratorVisualIDRegistry.getType(model.diagram.edit.parts.ContextRelationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
