...
public class InstanceNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ModelParserProvider.getParser(ModelElementTypes.Instance_2001, getParserElement(),
					ModelVisualIDRegistry.getType(model.diagram.edit.parts.InstanceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
