...
public class InstanceNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GeneratorParserProvider.getParser(GeneratorElementTypes.Instance_2001, getParserElement(),
					GeneratorVisualIDRegistry.getType(model.diagram.edit.parts.InstanceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
