...
public class TypeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GeneratorParserProvider.getParser(GeneratorElementTypes.Type_2008, getParserElement(),
					GeneratorVisualIDRegistry.getType(model.diagram.edit.parts.TypeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
