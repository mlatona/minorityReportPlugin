...
import model.diagram.edit.policies.ContextRelationItemSemanticEditPolicy;
...
public class ContextRelationEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ContextRelationNameEditPart) {
			((ContextRelationNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureContextRelationNameFigure());
			return true;
		}
		if (childEditPart instanceof ContextRelationTimeEditPart) {
			((ContextRelationTimeEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureContextRelationTimeFigure());
			return true;
		}
		if (childEditPart instanceof ContextRelationValueEditPart) {
			((ContextRelationValueEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureContextRelationValueFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ModelVisualIDRegistry.getType(ContextRelationNameEditPart.VISUAL_ID));
	}
