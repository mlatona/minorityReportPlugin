...
public class ContextRelationEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ContextRelationNameEditPart) {
			((ContextRelationNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureTypeNameFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(GeneratorVisualIDRegistry.getType(ContextRelationNameEditPart.VISUAL_ID));
	}
