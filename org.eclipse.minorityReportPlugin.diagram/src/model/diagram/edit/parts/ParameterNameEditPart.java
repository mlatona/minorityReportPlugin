...
public class ParameterNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ModelParserProvider.getParser(ModelElementTypes.Parameter_2006, getParserElement(),
					ModelVisualIDRegistry.getType(model.diagram.edit.parts.ParameterNameEditPart.VISUAL_ID));
		}
		return parser;
	}
