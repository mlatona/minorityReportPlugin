...
public class ParameterNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GeneratorParserProvider.getParser(GeneratorElementTypes.Parameter_2006, getParserElement(),
					GeneratorVisualIDRegistry.getType(model.diagram.edit.parts.ParameterNameEditPart.VISUAL_ID));
		}
		return parser;
	}
