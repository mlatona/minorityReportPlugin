...
import model.diagram.edit.policies.GeneratorTextSelectionEditPolicy;
 ...
 * @generated
 */
public class BehaviouralDescriptionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public BehaviouralDescriptionNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new GeneratorTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return GeneratorElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GeneratorParserProvider.getParser(GeneratorElementTypes.BehaviouralDescription_2010,
					getParserElement(), GeneratorVisualIDRegistry
							.getType(model.diagram.edit.parts.BehaviouralDescriptionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, GeneratorEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
