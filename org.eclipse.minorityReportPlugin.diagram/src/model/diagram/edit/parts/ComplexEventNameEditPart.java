...
public class ComplexEventNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ModelParserProvider.getParser(ModelElementTypes.ComplexEvent_2005, getParserElement(),
					ModelVisualIDRegistry.getType(model.diagram.edit.parts.ComplexEventNameEditPart.VISUAL_ID));
		}
		return parser;
	}
