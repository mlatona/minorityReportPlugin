...
public class ComplexEventNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GeneratorParserProvider.getParser(GeneratorElementTypes.ComplexEvent_2005, getParserElement(),
					GeneratorVisualIDRegistry.getType(model.diagram.edit.parts.ComplexEventNameEditPart.VISUAL_ID));
		}
		return parser;
	}
