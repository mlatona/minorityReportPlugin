 ...
 * @generated
 */
public class GeneratorVisualIDRegistry {
	...
	*/
	public static int getVisualID(View view) {
		...
		return model.diagram.part.GeneratorVisualIDRegistry.getVisualID(view.getType());
	}
	...
	*/
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = model.diagram.part.GeneratorVisualIDRegistry.getModelID(containerView);
		if (!EnvironmentEditPart.MODEL_ID.equals(containerModelID)) {
			return -1;
		}
		int containerVisualID;
		if (EnvironmentEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = model.diagram.part.GeneratorVisualIDRegistry.getVisualID(containerView);
		} else {
	...
	public static final DiagramStructure TYPED_INSTANCE = new DiagramStructure() {
		...
		*/
		...
		public int getVisualID(View view) {
			return model.diagram.part.GeneratorVisualIDRegistry.getVisualID(view);
		}
		...
		*/
		...
		public String getModelID(View view) {
			return model.diagram.part.GeneratorVisualIDRegistry.getModelID(view);
		}
		...
		*/
		...
		public int getNodeVisualID(View containerView, EObject domainElement) {
			return model.diagram.part.GeneratorVisualIDRegistry.getNodeVisualID(containerView, domainElement);
		}
		...
		*/
		...
		public boolean checkNodeVisualID(View containerView, EObject domainElement, int candidate) {
			return model.diagram.part.GeneratorVisualIDRegistry.checkNodeVisualID(containerView, domainElement,
					candidate);
		}
		...
		*/
		...
		public boolean isCompartmentVisualID(int visualID) {
			return model.diagram.part.GeneratorVisualIDRegistry.isCompartmentVisualID(visualID);
		}
		...
		*/
		...
		public boolean isSemanticLeafVisualID(int visualID) {
			return model.diagram.part.GeneratorVisualIDRegistry.isSemanticLeafVisualID(visualID);
		}
	};
