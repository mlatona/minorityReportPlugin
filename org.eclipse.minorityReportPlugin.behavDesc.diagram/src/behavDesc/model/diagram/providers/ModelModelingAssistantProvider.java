...
public class ModelModelingAssistantProvider extends ModelingAssistantProvider {
	...
	*/
	protected EObject selectElement(EObject[] elements) {
		...
		dialog.setMessage(behavDesc.model.diagram.part.Messages.ModelModelingAssistantProviderMessage);
		dialog.setTitle(behavDesc.model.diagram.part.Messages.ModelModelingAssistantProviderTitle);
