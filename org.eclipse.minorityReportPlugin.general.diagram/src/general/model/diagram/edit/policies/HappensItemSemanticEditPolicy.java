...
import general.model.diagram.edit.commands.BehaviouralDescriptionHappensCreateCommand;
import general.model.diagram.edit.commands.BehaviouralDescriptionHappensReorientCommand;
...
import general.model.diagram.edit.commands.InitiallyHappensCreateCommand;
import general.model.diagram.edit.commands.InitiallyHappensReorientCommand;
 ...
 * @generated
 */
public class HappensItemSemanticEditPolicy extends ModelBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public HappensItemSemanticEditPolicy() {
		super(ModelElementTypes.Happens_2005);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (ModelVisualIDRegistry.getVisualID(incomingLink) == InitiallyHappensEditPart.VISUAL_ID) {
			...
			if (ModelVisualIDRegistry.getVisualID(incomingLink) == BehaviouralDescriptionHappensEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (ModelVisualIDRegistry.getVisualID(outgoingLink) == HappensEventEditPart.VISUAL_ID) {
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (ModelElementTypes.BehaviouralDescriptionHappens_4017 == req.getElementType()) {
			return null;
		}
		return null;
	}
