...
import general.model.diagram.edit.commands.InstanceTypeCreateCommand;
import general.model.diagram.edit.commands.InstanceTypeReorientCommand;
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (ModelVisualIDRegistry.getVisualID(incomingLink) == ParameterTypeEditPart.VISUAL_ID) {
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (ModelElementTypes.InstanceType_4018 == req.getElementType()) {
			return null;
		}
		return null;
	}
