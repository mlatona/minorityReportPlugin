...
public class HoldsAtContextRelationReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return ModelBaseItemSemanticEditPolicy.getLinkConstraints().canExistHoldsAtContextRelation_4001(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return ModelBaseItemSemanticEditPolicy.getLinkConstraints().canExistHoldsAtContextRelation_4001(getOldSource(),
				getNewTarget());
	}
