...
import general.model.diagram.edit.policies.ComplexEventItemSemanticEditPolicy;
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ComplexEventNameEditPart) {
			((ComplexEventNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureComplexEventNameFigure());
			return true;
		}
		return false;
	}
