...
import general.model.diagram.edit.policies.ModelTextSelectionEditPolicy;
...
public class BehaviouralDescriptionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ModelParserProvider.getParser(ModelElementTypes.BehaviouralDescription_2007, getParserElement(),
					ModelVisualIDRegistry
							.getType(general.model.diagram.edit.parts.BehaviouralDescriptionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
