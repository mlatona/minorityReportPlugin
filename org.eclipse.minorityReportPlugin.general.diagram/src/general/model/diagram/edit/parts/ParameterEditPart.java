...
import general.model.diagram.edit.policies.ParameterItemSemanticEditPolicy;
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ParameterNameEditPart) {
			((ParameterNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureParameterNameFigure());
			return true;
		}
		return false;
	}
