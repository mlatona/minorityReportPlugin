 ...
 * @generated
 */
public class HappensTimeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public HappensTimeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ModelParserProvider.getParser(ModelElementTypes.Happens_2005, getParserElement(),
					ModelVisualIDRegistry.getType(general.model.diagram.edit.parts.HappensTimeEditPart.VISUAL_ID));
		}
		return parser;
	}
