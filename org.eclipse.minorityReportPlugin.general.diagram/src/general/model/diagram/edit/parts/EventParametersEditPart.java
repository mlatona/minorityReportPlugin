...
import general.model.diagram.edit.policies.EventParametersItemSemanticEditPolicy;
...
public class EventParametersEditPart extends ConnectionNodeEditPart implements ITreeBranchEditPart {
	...
	*/
	...
	protected Connection createConnectionFigure() {
		return new EventParametersFigure();
	}

	/**
	* @generated
	*/
	public EventParametersFigure getPrimaryShape() {
		return (EventParametersFigure) getFigure();
	}

	/**
	 * @generated
	 */
	public class EventParametersFigure extends PolylineConnectionEx {

		/**
		 * @generated
		 */
		public EventParametersFigure() {
