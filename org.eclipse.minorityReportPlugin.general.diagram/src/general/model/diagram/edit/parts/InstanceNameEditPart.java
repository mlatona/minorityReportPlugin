...
public class InstanceNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ModelParserProvider.getParser(ModelElementTypes.Instance_2004, getParserElement(),
					ModelVisualIDRegistry.getType(general.model.diagram.edit.parts.InstanceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
