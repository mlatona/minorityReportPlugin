...
public class TypeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ModelParserProvider.getParser(ModelElementTypes.Type_2001, getParserElement(),
					ModelVisualIDRegistry.getType(general.model.diagram.edit.parts.TypeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
