...
import general.model.diagram.edit.policies.TypeItemSemanticEditPolicy;
	...
	*/
	...
	public class TypeFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureTypeTitle.setLocation(new Point(getMapMode().DPtoLP(20), getMapMode().DPtoLP(30)));
	 ...
	 * @generated
	 */
	static final Color THIS_FORE = new Color(null, 204, 0, 0);

	/**
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 204, 0, 0);
