...
public class ParameterNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ModelParserProvider.getParser(ModelElementTypes.Parameter_2002, getParserElement(),
					ModelVisualIDRegistry.getType(general.model.diagram.edit.parts.ParameterNameEditPart.VISUAL_ID));
		}
		return parser;
	}
