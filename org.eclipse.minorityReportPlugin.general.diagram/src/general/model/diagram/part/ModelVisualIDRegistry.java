...
public class ModelVisualIDRegistry {
	...
	* @generated
	*/
	private static final String DEBUG_KEY = "org.eclipse.minorityReportPlugin.general.diagram/debug/visualID"; //$NON-NLS-1$
	...
	*/
	public static int getVisualID(View view) {
		...
		return general.model.diagram.part.ModelVisualIDRegistry.getVisualID(view.getType());
	}
	...
	*/
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = general.model.diagram.part.ModelVisualIDRegistry.getModelID(containerView);
		if (!EnvironmentEditPart.MODEL_ID.equals(containerModelID)) {
			return -1;
		}
		int containerVisualID;
		if (EnvironmentEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = general.model.diagram.part.ModelVisualIDRegistry.getVisualID(containerView);
		} else {
	...
	*/
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case HappensEditPart.VISUAL_ID:
			if (HappensTimeEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		...
		case HoldsAtEditPart.VISUAL_ID:
			if (HoldsAtTimeEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
	...
	public static final DiagramStructure TYPED_INSTANCE = new DiagramStructure() {
		...
		*/
		...
		public int getVisualID(View view) {
			return general.model.diagram.part.ModelVisualIDRegistry.getVisualID(view);
		}
		...
		*/
		...
		public String getModelID(View view) {
			return general.model.diagram.part.ModelVisualIDRegistry.getModelID(view);
		}
		...
		*/
		...
		public int getNodeVisualID(View containerView, EObject domainElement) {
			return general.model.diagram.part.ModelVisualIDRegistry.getNodeVisualID(containerView, domainElement);
		}
		...
		*/
		...
		public boolean checkNodeVisualID(View containerView, EObject domainElement, int candidate) {
			return general.model.diagram.part.ModelVisualIDRegistry.checkNodeVisualID(containerView, domainElement,
					candidate);
		}
		...
		*/
		...
		public boolean isCompartmentVisualID(int visualID) {
			return general.model.diagram.part.ModelVisualIDRegistry.isCompartmentVisualID(visualID);
		}
		...
		*/
		...
		public boolean isSemanticLeafVisualID(int visualID) {
			return general.model.diagram.part.ModelVisualIDRegistry.isSemanticLeafVisualID(visualID);
		}
	};
