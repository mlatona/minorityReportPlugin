 ...
 * @generated
 */
public class HappensEventReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public HappensEventReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Event && newEnd instanceof Happens)) {
			return false;
		}
		return ModelBaseItemSemanticEditPolicy.getLinkConstraints().canExistHappensEvent_4007(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return ModelBaseItemSemanticEditPolicy.getLinkConstraints().canExistHappensEvent_4007(getOldSource(),
				getNewTarget());
	}
