...
public class ContextRelationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ModelParserProvider.getParser(ModelElementTypes.ContextRelation_2011, getParserElement(),
					ModelVisualIDRegistry.getType(model.diagram.edit.parts.ContextRelationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
