...
public class PrimitiveEventItemProvider extends EventItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.PRIMITIVE_EVENT__AGENT);
			childrenFeatures.add(ModelPackage.Literals.PRIMITIVE_EVENT__OBSERVER);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PrimitiveEvent.class)) {
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == ModelPackage.Literals.EVENT__PARAMETERS ||
			childFeature == ModelPackage.Literals.PRIMITIVE_EVENT__AGENT ||
			childFeature == ModelPackage.Literals.PRIMITIVE_EVENT__OBSERVER;
