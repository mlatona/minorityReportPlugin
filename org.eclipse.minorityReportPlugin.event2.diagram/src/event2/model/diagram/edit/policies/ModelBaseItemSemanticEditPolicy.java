...
public class ModelBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	*/
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = Event2ModelDiagramEditorPlugin.getInstance().getLinkConstraints();
		if (cached == null) {
			Event2ModelDiagramEditorPlugin.getInstance().setLinkConstraints(cached = new LinkConstraints());
		}
		return cached;
	}
	...
	public static class LinkConstraints {
		...
		*/
		 ...
		 * @generated
		 */
		public boolean canCreatePrimitiveEvent_4001(Environment container, Agent source, Observer target) {
			return canExistPrimitiveEvent_4001(container, null, source, target);
		}

		/**
		* @generated
		*/
		public boolean canExistPrimitiveEvent_4001(Environment container, PrimitiveEvent linkInstance, Agent source,
				Observer target) {
			return true;
		}
	}
