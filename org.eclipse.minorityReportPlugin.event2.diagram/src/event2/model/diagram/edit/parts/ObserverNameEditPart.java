...
import event2.model.diagram.edit.policies.ModelTextSelectionEditPolicy;
...
public class ObserverNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ModelVisualIDRegistry.getType(event2.model.diagram.edit.parts.ObserverNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ModelParserProvider.getParser(ModelElementTypes.Observer_2002, getParserElement(),
					ModelVisualIDRegistry.getType(event2.model.diagram.edit.parts.ObserverNameEditPart.VISUAL_ID));
		}
		return parser;
	}
