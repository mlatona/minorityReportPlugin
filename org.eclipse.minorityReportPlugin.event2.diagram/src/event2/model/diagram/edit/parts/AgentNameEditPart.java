...
public class AgentNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ModelVisualIDRegistry.getType(event2.model.diagram.edit.parts.AgentNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ModelParserProvider.getParser(ModelElementTypes.Agent_2001, getParserElement(),
					ModelVisualIDRegistry.getType(event2.model.diagram.edit.parts.AgentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
