...
import event2.model.diagram.edit.policies.AgentItemSemanticEditPolicy;
...
public class AgentEditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	protected IFigure createNodeShape() {
		URL url = FileLocator.find(Event2ModelDiagramEditorPlugin.getInstance().getBundle(),
				new Path("icons/agent.svg"), null); //$NON-NLS-1$
