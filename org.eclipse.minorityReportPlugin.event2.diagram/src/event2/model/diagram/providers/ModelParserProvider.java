...
import event2.model.diagram.parsers.MessageFormatParser;
...
public class ModelParserProvider extends AbstractProvider implements IParserProvider {
	...
	* @generated
	*/
	private IParser agentName_5001Parser;

	/**
	* @generated
	*/
	private IParser getAgentName_5001Parser() {
		if (agentName_5001Parser == null) {
			EAttribute[] features = new EAttribute[] { ModelPackage.eINSTANCE.getParameter_Name() };
			MessageFormatParser parser = new MessageFormatParser(features);
			agentName_5001Parser = parser;
		}
		return agentName_5001Parser;
	}

	/**
	* @generated
	*/
	private IParser observerName_5002Parser;

	/**
	* @generated
	*/
	private IParser getObserverName_5002Parser() {
		if (observerName_5002Parser == null) {
			EAttribute[] features = new EAttribute[] { ModelPackage.eINSTANCE.getParameter_Name() };
			MessageFormatParser parser = new MessageFormatParser(features);
			observerName_5002Parser = parser;
		}
		return observerName_5002Parser;
	}
	...
	*/
	protected IParser getParser(int visualID) {
		...
		case AgentNameEditPart.VISUAL_ID:
			return getAgentName_5001Parser();
		case ObserverNameEditPart.VISUAL_ID:
			return getObserverName_5002Parser();
		}
		return null;
	}
