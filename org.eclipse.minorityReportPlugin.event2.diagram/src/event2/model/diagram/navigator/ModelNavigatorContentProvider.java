...
import event2.model.diagram.part.Messages;
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case AgentEditPart.VISUAL_ID: {
			...
			ModelNavigatorGroup outgoinglinks = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_Agent_2001_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
		...
		case ObserverEditPart.VISUAL_ID: {
			...
			ModelNavigatorGroup incominglinks = new ModelNavigatorGroup(
					Messages.NavigatorGroupName_Observer_2002_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
		...
		case PrimitiveEventEditPart.VISUAL_ID: {
			LinkedList<ModelAbstractNavigatorItem> result = new LinkedList<ModelAbstractNavigatorItem>();
			Edge sv = (Edge) view;
			ModelNavigatorGroup target = new ModelNavigatorGroup(Messages.NavigatorGroupName_PrimitiveEvent_4001_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			ModelNavigatorGroup source = new ModelNavigatorGroup(Messages.NavigatorGroupName_PrimitiveEvent_4001_source,
