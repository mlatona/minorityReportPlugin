...
public class ModelVisualIDRegistry {
	...
	*/
	public static int getVisualID(View view) {
		...
		return event2.model.diagram.part.ModelVisualIDRegistry.getVisualID(view.getType());
	}
	...
	public static int getVisualID(String type) {
		try {
			...
			if (Boolean.TRUE.toString().equalsIgnoreCase(Platform.getDebugOption(DEBUG_KEY))) {
				Event2ModelDiagramEditorPlugin.getInstance()
	...
	*/
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = event2.model.diagram.part.ModelVisualIDRegistry.getModelID(containerView);
		if (!EnvironmentEditPart.MODEL_ID.equals(containerModelID)) {
			return -1;
		}
		int containerVisualID;
		if (EnvironmentEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = event2.model.diagram.part.ModelVisualIDRegistry.getVisualID(containerView);
		} else {
	...
	public static final DiagramStructure TYPED_INSTANCE = new DiagramStructure() {
		...
		*/
		...
		public int getVisualID(View view) {
			return event2.model.diagram.part.ModelVisualIDRegistry.getVisualID(view);
		}
		...
		*/
		...
		public String getModelID(View view) {
			return event2.model.diagram.part.ModelVisualIDRegistry.getModelID(view);
		}
		...
		*/
		...
		public int getNodeVisualID(View containerView, EObject domainElement) {
			return event2.model.diagram.part.ModelVisualIDRegistry.getNodeVisualID(containerView, domainElement);
		}
		...
		*/
		...
		public boolean checkNodeVisualID(View containerView, EObject domainElement, int candidate) {
			return event2.model.diagram.part.ModelVisualIDRegistry.checkNodeVisualID(containerView, domainElement,
					candidate);
		}
		...
		*/
		...
		public boolean isCompartmentVisualID(int visualID) {
			return event2.model.diagram.part.ModelVisualIDRegistry.isCompartmentVisualID(visualID);
		}
		...
		*/
		...
		public boolean isSemanticLeafVisualID(int visualID) {
			return event2.model.diagram.part.ModelVisualIDRegistry.isSemanticLeafVisualID(visualID);
		}
	};
