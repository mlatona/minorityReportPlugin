...
public class ModelModelingAssistantProvider extends ModelingAssistantProvider {
	...
	*/
	protected EObject selectElement(EObject[] elements) {
		...
		dialog.setMessage(contextRelation.model.diagram.part.Messages.ModelModelingAssistantProviderMessage);
		dialog.setTitle(contextRelation.model.diagram.part.Messages.ModelModelingAssistantProviderTitle);
