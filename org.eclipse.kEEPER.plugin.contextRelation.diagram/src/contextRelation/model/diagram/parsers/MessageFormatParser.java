...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(contextRelation.model.diagram.part.ModelDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(contextRelation.model.diagram.part.Messages.MessageFormatParser_InvalidInputError,
