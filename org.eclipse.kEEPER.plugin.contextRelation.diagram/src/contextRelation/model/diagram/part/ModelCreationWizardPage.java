...
public class ModelCreationWizardPage extends WizardNewFileCreationPage {
	...
	*/
	public void createControl(Composite parent) {
		...
		setFileName(contextRelation.model.diagram.part.ModelDiagramEditorUtil.getUniqueFileName(getContainerFullPath(),
	...
	*/
	protected boolean validatePage() {
		...
		if (extension != null && !getFilePath().toString().endsWith("." + extension)) {
			setErrorMessage(NLS.bind(contextRelation.model.diagram.part.Messages.ModelCreationWizardPageExtensionError,
					extension));
			return false;
		}
		return true;
