...
public class ModelDomainNavigatorLabelProvider implements ICommonLabelProvider {
	...
	*/
	public Image getImage(Object element) {
		if (element instanceof contextRelation.model.diagram.navigator.ModelDomainNavigatorItem) {
			return myAdapterFactoryLabelProvider.getImage(
					((contextRelation.model.diagram.navigator.ModelDomainNavigatorItem) element).getEObject());
		}
		return null;
	}
	...
	public String getText(Object element) {
		if (element instanceof contextRelation.model.diagram.navigator.ModelDomainNavigatorItem) {
			return myAdapterFactoryLabelProvider
					.getText(((contextRelation.model.diagram.navigator.ModelDomainNavigatorItem) element).getEObject());
		}
		return null;
	}
