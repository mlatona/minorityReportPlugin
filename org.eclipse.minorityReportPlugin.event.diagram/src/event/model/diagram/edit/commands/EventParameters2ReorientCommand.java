 ...
 * @generated
 */
public class EventParameters2ReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public EventParameters2ReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return ModelBaseItemSemanticEditPolicy.getLinkConstraints().canExistEventParameters_4005(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return ModelBaseItemSemanticEditPolicy.getLinkConstraints().canExistEventParameters_4005(getOldSource(),
				getNewTarget());
	}
