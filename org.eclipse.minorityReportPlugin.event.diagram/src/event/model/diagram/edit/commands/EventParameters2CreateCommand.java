 ...
 * @generated
 */
public class EventParameters2CreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public EventParameters2CreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return ModelBaseItemSemanticEditPolicy.getLinkConstraints().canCreateEventParameters_4005(getSource(),
				getTarget());
	}
